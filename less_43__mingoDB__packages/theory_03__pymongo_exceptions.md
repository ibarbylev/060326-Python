...
| ----------------------------- | ------------------------------------------ | --------------------------------------------------------- | ------------------------------------------- |
| `PyMongoError`                | **Базовый класс всех исключений PyMongo**  | Любая ошибка, возникшая при работе с PyMongo              | `class DatabaseError(Exception)`            |
...
def insert_user(user):
    try:
        ...
        raise DatabaseError("Ошибка MongoDB") from e
```
